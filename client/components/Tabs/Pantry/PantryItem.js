  ...
  return (
    <Swipeout right={swipeOutButtons} backgroundColor={'transparent'} close>
      <SafeAreaView style={tailwind('flex flex-row justify-between px-4 py-4')}>
        <View nativeID={`pantryItem${item_name}`} style={tailwind('flex flex-col items-center justify-center')}>
          <Text style={tailwind('flex items-center text-sm text-gray-500')}>
            {category}
          </Text>
          <Text style={tailwind('text-lg font-bold text-blue-700')} nativeID={`pantryItemItemName${item_name}`} >
            {item_name}
          </Text>
        </View>
        ...
        <View style={tailwind('flex flex-row justify-around w-2/5')}>
          <View
            ...
            <View style={tailwind('flex justify-center items-center')}>
              <Text style={tailwind('text-3xl font-semibold text-blue-700')} nativeID={`pantryQty${item_name}`}>
                {qty}
              </Text>
              <Text>{unit}</Text>
            </View>
          ...
          <View
            ...
            <View style={tailwind('flex justify-center items-center')}>
              <Text style={tailwind('text-3xl font-semibold text-blue-700')} nativeID={`pantryReqQty${item_name}`}>
                {par}
              </Text>
              <Text>{unit}</Text>
            </View>
