...
const ShoppingItem = ({itemDetails}) => {
  ...
  return (
    <Swipeout right={swipeOutButtons} backgroundColor={'transparent'} close>
      <View nativeID={`shoppingItem${item_name}`} style={tailwind('flex flex-row justify-between px-4 py-4')}>
        ...
        <View style={tailwind('flex flex-row justify-around w-2/5')}>
          <View
            ...
            <View style={tailwind('flex justify-center items-center')}>
              <Text style={tailwind('text-3xl font-semibold text-blue-700')} nativeID={`ShoppingCartQuantity${item_name}`}>
                {buy_qty}
              </Text>
              <Text>{unit}</Text>
            </View>
            <View style={tailwind('flex flex-row')}>
              <MinusBuyButton item_name={item_name} _id={_id} />
              <AddBuyButton item_name={item_name} _id={_id} />
            </View>
          </View>
          ...
          <View
            ...
            <View style={tailwind('flex justify-center items-center')}>
              <Text style={tailwind('text-3xl font-semibold text-blue-700')} nativeID={`ShoppingReqCartQuantity${item_name}`}>
                {list_qty}
              </Text>
              <Text>{unit}</Text>
            </View>
            ...
            <View style={tailwind('flex flex-row')}>
              <MinusListButton item_name={item_name} _id={_id} />
              <AddListButton item_name={item_name} _id={_id} />
            </View>
          </View>
        </View>
      </View>
